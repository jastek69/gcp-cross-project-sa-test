...
<html>
<head>
  <title>T.I.Q.S. - Armageddon Task 1</title>
  <meta charset="UTF-8">
  ...
  <style>
    ...
    .bgimg {
      background-image: url('https://upload.wikimedia.org/wikipedia/commons/0/0e/Night_view_of_Rio_de_Janeiro_just_before_sunrise.jpg');
      min-height: 100%;
...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="https://cdn.acidcow.com/pics/20180723/brazilian_tv_10.gif"
              width="480"
              height="270"
              align="center"
              valign="middle"
    ...
    <div class="w3-display-bottomleft w3-padding-small transparent-background outlined-text">
      <h1>T.I.Q.S. - Armageddon Task 1</h1>
      <h3>"I, TIQS, will make 300,000 per year thanks to Theo and El Guapo"</h3>
