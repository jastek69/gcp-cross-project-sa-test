...
<html>
<head>
  <title>6.5 Armageddon - Michael Dale</title>
  <meta charset="UTF-8">
...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="https://videos.pond5.com/attractive-and-strong-african-woman-footage-234256487_main_xxl.mp4"
              width="500"
              height="270"
    ...
    <div class="w3-display-bottomleft w3-padding-small transparent-background outlined-text">
      <h1>Toronto Compute Instance Information</h1>
      <h3></h3>
